...
// https://github.com/react-native-toolkit/triangle/blob/master/src/index.tsx
...
export interface ITriangleProps extends ViewProps {
    color: string;
    type?: triangleTypeTypes;
}

export interface IEquilateralTriangle extends ITriangleProps {
    type?: "equilateral";
...
export default function Triangle (props: ITriangle){
